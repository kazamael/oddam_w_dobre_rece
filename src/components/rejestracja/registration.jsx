...
export class Registration extends React.Component{
    ...
    render() {
        const {login, password,passwordRepeat,loginvalid,passwordvalid,passwordrepeatvalid} = this.state;
        ...
        let passwordrepeatStyle;
        {
            !passwordrepeatvalid ? passwordrepeatStyle = {"border-bottom": "2px solid #737373"} : passwordrepeatStyle = {"border-bottom": "2px solid red"}
        }
                ...
                <div className="login_article">
                    ...
                    <form className="login_form" action="">
                        <div className="login_form_item">
                            ...
                            <input style={logiStyle} onChange={this.handleInputChange} name="login" value={login} className="login_form_input" type="text"/>
                        ...
                        <div className="login_form_item">
                            ...
                            <input style={passwordStyle} onChange={this.handleInputChange} name="password" value={password} className="login_form_input" type="text"/>
                        ...
                        <div className="login_form_item">
                            ...
                            <input style={passwordrepeatStyle} onChange={this.handleInputChange} name="passwordRepeat" value={passwordRepeat} className="login_form_input" type="text"/>
                            {passwordrepeatvalid && <span className="validationerror">hasło nie zgadza się z pierwszym!</span>}
                        </div>
                    </form>
                    <div className="login_buttons">
                        <button className="login_button"><Link className="header_nav1_link" to="/login">Zaloguj się</Link></button>
                        <button onClick={this.handleButtonClick} className="login_button">Załóż konto</button>
                    </div>
                </div>
            </>
        )
